...
wk.register({
  ...
  r = {
    ...
    ["8"] = { "<Cmd>lua require('refactoring').refactor('Extract Block')<CR>", "Extract block (refactoring.nvim)" },
    ["9"] = { "<Cmd>lua require('refactoring').refactor('Extract Block To File')<CR>", "Extract block to file (refactoring.nvim)" },
    ["0"] = { "<Cmd>lua require('refactoring').refactor('Inline Variable')<CR>", "Inline variable (refactoring.nvim)" },
  },
  w = {
    name = "whitespace",
...
wk.register({
  r = {
    ...
    ["1"] = { ":TSCppDefineClassFunc<CR>", "Implement class member functions (c++)" },
    ["2"] = { ":TSCppMakeConcreteClass<CR>", "Implement pure virtual functions (c++)" },
    ["3"] = { ":TSCppRuleOf3<CR>", "Modify class to obey Rule of 3 (c++)" },
    ["4"] = { ":TSCppRuleOf5<CR>", "Modify class to obey Rule of 5 (c++)" },
    ["5"] = { "<Esc><Cmd>lua require('refactoring').refactor('Extract Variable')<CR>", "Extract variable (refactoring.nvim)" },
    ["6"] = { "<Esc><Cmd>lua require('refactoring').refactor('Extract Function')<CR>", "Extract function (refactoring.nvim)" },
    ["7"] = { "<Esc><Cmd>lua require('refactoring').refactor('Extract Function To File')<CR>", "Extract function to file (refactoring.nvim)" },
  },
