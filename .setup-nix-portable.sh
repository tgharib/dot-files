...
alias enter-dev='NP_RUNTIME=bwrap nix shell github:nixos/nixpkgs/nixos-23.11#{ripgrep,sd,fd,as-tree,fzf,abduco,lazygit,du-dust,bat,btop,difftastic,yazi,trash-cli,neovim,tree-sitter,nodejs,gcc,pazi}'
