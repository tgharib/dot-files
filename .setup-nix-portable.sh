...
PATH="${PATH:+${PATH}:}~/bin"
alias enter-dev='NP_RUNTIME=bwrap nix shell github:nixos/nixpkgs/nixos-23.05#{ripgrep,sd,fd,as-tree,fzf,abduco,lazygit,du-dust,bat,btop,difftastic,neovim,tree-sitter,nodejs,gcc,pazi}'
